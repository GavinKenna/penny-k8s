  ...
  <div class="flex h-full">
    ...
    <div class="w-1/2 p-6 overflow-y-auto">
      ...
      <header class="mb-6">
        ...
        <p class="text-gray-600">A summary of your Namespaces, with live pod & deployment counts.</p>
      </header>
      ...
      <div class="grid gap-4 grid-cols-1 sm:grid-cols-2">
        ...
        >
          <h3 class="text-xl font-semibold text-gray-800 mb-1">{{ ns.name }}</h3>
    ...
    <div class="w-1/2 p-6 overflow-y-auto border-l" v-if="selectedNamespace">
      ...
      <div class="space-y-4 text-sm text-gray-700">
        <p><strong>Age:</strong> {{ formatDate(selectedNamespace.creationTimestamp) }}</p>
        <p><strong>Pods:</strong> {{ podCount[selectedNamespace.name] || 0 }}</p>
        <p><strong>Deployments:</strong> {{ deploymentCount[selectedNamespace.name] || 0 }}</p>
